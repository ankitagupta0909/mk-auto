...
myxl.Workbooks.Open "C:\CommonFramework_MB_v9\Automation Framework\Framework\src\testdata\testWorkbook.xlsx"
...
' read the main and sub folder names
 folder = "KYC Automation"&RandomStr
 subfolder = "AutomationCases"&RandomStr

On Error Resume Next
' create main folder
'Set subjectfldr = subjectfldr.AddNode("KYC Automation")
