...
myxl.Workbooks.Open "C:\\AutomationWorkspace\\Framework\\src\\testdata\\MCPMmappingSheet.xlsx"
...
qcUser = "chhavi.gupta"
qcPassword = "chhavi.gupta"
qcDomain = "EQUITIES_INDICES"
qcProject = "MCPM"
    ...
    Set TestNode=QCTreeManager.nodebypath("Subject\Automation Test\MissingReportsProd")
    ...
    Set  TreeNode=QCTSTreeManager.NodebyPath("Root\Automation 3.10")
...
' read the main and sub folder names
 folder = "MCPMAutomation"&RandomStr
 subfolder = "AutomationCases"&RandomStr

On Error Resume Next
' create main folder
'Set subjectfldr = subjectfldr.AddNode("MCPM Automation")
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    Set QCTSTreeManager = QCConnection.TestSetTreeManager     
    Set  TreeNode=QCTSTreeManager.NodebyPath("Root\MCPMAutomation")
    Set TestSetFact=TreeNode.TestSetFactory
    
    Set NewTestSet=TestSetFact.AddItem(Null)' Creates new testset
    NewTestSet.name="MCPM Automation Suite"&RandomStr
